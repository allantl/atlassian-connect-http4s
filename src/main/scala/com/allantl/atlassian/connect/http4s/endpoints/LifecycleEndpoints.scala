...
import com.allantl.atlassian.connect.http4s.auth.atlassian.jwt.JwtAuthenticator
...
class LifecycleEndpoints[F[_]: Effect: JwtAuthenticator](lifecycleService: LifecycleService[F]) extends Http4sDsl[F] {
